...
<div class="row">
          ...
          <a href="#" class="d-flex align-items-center border-bottom py-3">
            ...
            <div class="w-100">
              <div class="d-flex justify-content-between">
                <h6 class="text-body mb-2">{{ $user->full_name }}</h6>
                <p class="text-muted tx-12">{{ $user->getDateTimeAttribute() }}</p>
              </div>
              <p class="text-muted tx-13">{{ $user->company_name }}</p>
            </div>
          </a>
        @endforeach
  ...
  <div class="col-lg-7 col-xl-8 stretch-card">
    <!-- <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-2">
          <h6 class="card-title mb-0">RECENT REGISTERED USERS</h6>
          <div class="dropdown mb-2">
